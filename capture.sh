...
curl -sGS --retry 3 --retry-delay 5 --data-urlencode token=$ADVANCED_PG_BACKUPS_ADVANCED_PG_URL --data-urlencode access_key=$1 https://mighty-cove-51599.herokuapp.com/get -o check
